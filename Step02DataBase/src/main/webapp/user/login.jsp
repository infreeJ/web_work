...
<%
	...
	if(isSave != null) {
		// 입력한 아이디 비밀번호를 쿠키로 응답하고 1주일 동안 유지되도록 한다.
		// 아이디 비밀번호를 응답하고 1주일 동안 유지되도록 한다.
		...
		// 쿠키 경로 (따로 설정하지 않으면 현재 경로에서만 사용 가능)
		...
		// 쿠키 유지시간을 0으로 설정해서 쿠키가 응답하면 삭제되는 효과를 낸다
		cook1.setMaxAge(0);
		cook2.setMaxAge(0);
		response.addCookie(cook1);
		response.addCookie(cook2);
